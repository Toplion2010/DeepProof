...
import type { DocumentFinding } from "@/lib/document-analysis"
...
function getFindingIcon(finding: DocumentFinding) {
...
function getSourceLabel(source: "vision" | "metadata" | "text-analysis" | "system"): string {
  switch (source) {
    case "vision":
      return "Vision Model"
    case "metadata":
...
export function DocumentFindingsSection({ findings }: DocumentFindingsSectionProps) {
    ...
    <div className="rounded-xl border border-border bg-card">
      <div className="flex items-center justify-between border-b border-border px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold text-foreground">Forensic Findings</h3>
